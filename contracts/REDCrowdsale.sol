...
contract REDCrowdsale is CappedCrowdsale, FinalizableCrowdsale {
    ...
    REDContinuousSale public continuousSale;
    ...
    function createContinuousSaleContract() internal returns(REDContinuousSale) {
        return new REDContinuousSale(rate, wallet, token);
    }
